...
-- Creates: 5 customers → 5 jobs → 5 projects → phases → milestones
...
DECLARE
  ...
  -- Phase IDs (for projects 1 and 3)
...
BEGIN
  ...
  -- 1. Customers
  -- -----------------------------------------------------------------------
  INSERT INTO public.customers (id, tenant_id, first_name, last_name, email, phone, city, state, zip)
  VALUES
    (c1, v_tenant_id, 'Miguel',   'Hernandez',  'miguel.hernandez@email.com',  '(310) 555-0101', 'Los Angeles',   'CA', '90024'),
    (c2, v_tenant_id, 'Patricia', 'Johnson',    'pjohnson@email.com',           '(626) 555-0202', 'Pasadena',      'CA', '91103'),
    (c3, v_tenant_id, 'Carlos',   'Martinez',   'carlos.m@email.com',           '(818) 555-0303', 'Glendale',      'CA', '91205'),
    (c4, v_tenant_id, 'Robert',   'Thompson',   'rthompson@capitolgroup.com',   '(310) 555-0404', 'Beverly Hills', 'CA', '90210'),
    (c5, v_tenant_id, 'Linda',    'Wong',       'lwong@email.com',              '(818) 555-0505', 'Burbank',       'CA', '91502')
  ...
  INSERT INTO public.jobs (
    id, tenant_id, job_number, job_name, customer_id, status, job_type,
    start_date, target_completion,
    contract_amount_cents, current_contract_cents, contract_value_cents,
    address_line1, city, state, zip,
    job_address, description, notes, internal_notes,
    has_construction_loan, pm_user_id, superintendent_user_id,
    permit_number, permit_issued_date, permit_expiry_date,
    lender_name, loan_amount_cents,
    package_name, tags
  ) VALUES
    -- 1. Hernandez Residence — Active Custom, has construction loan
    (j1, v_tenant_id, 'GGB-2025-001', 'Hernandez Residence — Full Remodel', c1, 'active', 'custom',
    ...
    (j2, v_tenant_id, 'GGB-2025-002', 'Johnson Kitchen & Bath Renovation', c2, 'active', 'express',
    ...
    -- 4. Thompson Estate — Bidding (not yet started)
    (j4, v_tenant_id, 'GGB-2025-004', 'Thompson Estate — New Construction', c4, 'bidding', 'custom',
     null, null,
     185000000, null, null,
    ...
    (j5, v_tenant_id, 'GGB-2024-047', 'Wong Master Bathroom Remodel', c5, 'complete', 'express',
  ...
  VALUES
    ...
    (ph1c, p1, v_tenant_id, 'Finishes & Close-Out', 3, 'pending',    '#d1d5db', '2025-07-02', '2025-11-30')
  ON CONFLICT (id) DO NOTHING;

  -- Milestones for Hernandez
  INSERT INTO public.milestones (
    ...
    (gen_random_uuid(), p1, v_tenant_id, ph1b, 'Insulation & Drywall',        'pending',     7, '2025-06-20', null,         false, false, false, false),
    (gen_random_uuid(), p1, v_tenant_id, ph1b, 'Framing Draw Request',        'pending',     8, '2025-06-25', null,         true,  true,  true,  true),
    (gen_random_uuid(), p1, v_tenant_id, ph1c, 'Tile & Flooring',             'pending',     9, '2025-08-15', null,         false, false, false, false),
    (gen_random_uuid(), p1, v_tenant_id, ph1c, 'Cabinetry Install',           'pending',    10, '2025-09-01', null,         true,  false, false, false),
    (gen_random_uuid(), p1, v_tenant_id, ph1c, 'Final Inspection',            'pending',    11, '2025-11-10', null,         true,  true,  false, false),
    (gen_random_uuid(), p1, v_tenant_id, ph1c, 'Final Draw & Completion',     'pending',    12, '2025-11-30', null,         true,  true,  true,  true)
  ON CONFLICT (id) DO NOTHING;

  -- -----------------------------------------------------------------------
  -- 5. Phases — Martinez ADU (j3/p3)
  -- -----------------------------------------------------------------------
  INSERT INTO public.project_phases (id, project_id, tenant_id, name, sequence, status, color, start_date, end_date)
  VALUES
  ...
  INSERT INTO public.milestones (
    ...
    (gen_random_uuid(), p3, v_tenant_id, ph3b, 'Windows & Doors',         'pending',     7, '2025-07-10', null,         true,  false, false, false),
    (gen_random_uuid(), p3, v_tenant_id, ph3b, 'Weathertight Inspection', 'pending',     8, '2025-08-01', null,         false, false, false, false)
  ON CONFLICT (id) DO NOTHING;
  ...
  RAISE NOTICE '  Jobs    : 5 created (GGB-2025-001 through 003, 2025-004, 2024-047)';
  RAISE NOTICE '  Projects: 5 linked';
  RAISE NOTICE '  Phases  : 5 with milestones (Hernandez + Martinez ADU)';
  RAISE NOTICE '====================================================';
